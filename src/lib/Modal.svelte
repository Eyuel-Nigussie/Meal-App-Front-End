...
<script>
    ...
    const container = document.getElementById("toast-default");
    container.parentNode.removeChild(container);
  }
</script>
  
  <div id="toast-default" class="fixed top-28 left-32 md:left-96 z-50 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-red-400 dark:bg-red-800" role="alert">
    ...
    <button on:click="{handleClose}" type="button" class="close ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-default" aria-label="Close">
