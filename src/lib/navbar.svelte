    ...
    <div id="mySidenav" class="sidenav">
      ...
      <div id="main">
        <div class="navy py-[-20px] mt-0 h-30" style="font-size:30px;cursor:pointer" on:click={openNav}>
            <div class="hamburger m-0 mt-4 p-0 "> &#9776; </div>
            <img class="logo m-0" src="https://www.linkpicture.com/q/Meal_Planner-removebg-preview_1.png" width="150" height="80">
        </div>
      </div>
</section>
...
<section class="hidden md:block">
  <nav class="navmain border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center">
          ...
          <!-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Amref</span> -->
      </a>
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
          </li>
          <li>
...
.navy{
    ...
    display: flex;
    flex-direction: row;
    /* background-color: rgba(224, 128, 128, 0.419); */
}
