...
<footer class="footer p-10 bg-neutral text-neutral-content mb-8">
  <div>
    <img src="https://www.linkpicture.com/q/Meal_Planner-removebg-preview_1.png" class="h-20 w-20 mr-" alt="Amref Logo" />
    <p>AMREF HEALTH AFRICA<br/>Providing health care across africa</p>
  </div> 
  <div>
...
<footer class="md:hidden">
   <div class="fixed mb-[-18px] p-0 z-50 w-full h-16 max-w-xl -translate-x-1/2 bg-gradient-to-r from-white  from-1% via-red-500 via-50% to-red-3 00 to-1% border border-gray-200 rounded-lg bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
          ...
          <button data-tooltip-target="tooltip-home" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-l-full  group">
              <a href="/#/dashboard">
                <svg class="w-6 h-6 mb-1 text-white dark:text-gray-400 group-hover:text-black dark:group-hover:text-black" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <button data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5  group">
                <a href="/#/recipes">
                  <svg class="w-6 h-6 mb-1 text-white dark:text-gray-400 group-hover:text-black dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div class="flex items-center justify-center">
                <button data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-black rounded-full hover:bg-black group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
                    <a href="/#/addrecipe">
            ...
            <button data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center group">
              <a href="/#/planner"> 
                  <svg class="w-6 h-6 mb-1 text-white dark:text-gray-400 group-hover:text-black dark:group-hover:text-black" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <button data-tooltip-target="tooltip-profile" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-r-full  group">
                <a href="/#/profile">
                  <svg class="w-6 h-6 mb-1 text-white dark:text-gray-400 group-hover:text-black dark:group-hover:text-black" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
