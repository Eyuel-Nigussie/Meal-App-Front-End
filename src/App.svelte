...
<footer>
    <div class="fixed m-0 p-0 z-50 w-full h-16 max-w-xl -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
