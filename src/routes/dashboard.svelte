...
<!-- ====== Cards Section End -->
  <!-- Container -->
  <div class="container mx-auto bg-no-repeat"style=" background-image: url('https://thumbs.dreamstime.com/b/woman-rolling-dough-kitchen-happy-housewife-pin-cookie-person-kneads-adult-baking-cookies-pizza-pie-other-sweets-cartoon-239739646.jpg'); ">
    <div>
